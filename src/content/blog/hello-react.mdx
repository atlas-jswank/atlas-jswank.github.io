...
As developers we often want to use tools and languages that a browser may not be able to interpret directly. This include things like typescript, jsx, sass, less. Vite can take these formats and convert them into plain javascript and css.
